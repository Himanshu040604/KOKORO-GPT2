...
int main(int argc, const char ** argv) {
    ...
    args.add_argument(string_arg("--model-path", "(REQUIRED) The local path of the Kokoro GGUF model file or a directory containing only Kokoro GGUF model files.", "-mp", true));
